      ...
      <div class="col-sm-6 col-lg-4 my-4">
        <div class="card text-dark">
          <div class="card-body d-block align-items-center text-center px-xl-5 py-xl-4">
            ...
            <a class="btn btn-primary rounded-pill my-1" role="button" href="https://github.com/FreeCAD/FreeCAD/releases/download/0.19.1/FreeCAD_0.19-24276-macOS-x86_64-conda.dmg">64-Bit</a>
          </div>
          <div class="card-footer px-xl-5 py-xl-4">
            <small class="text-muted">
