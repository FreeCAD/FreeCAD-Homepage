...
if ($data) {
  ...
  if ($zip->open($tmpZip) === true) {
    ...
    for ($i = 0; $i < $zip->numFiles; $i++) {
      ...
      if (preg_match('~\.json$~i', $n)) { $jsonContent = $zip->getFromIndex($i); break; }
    }
    if ($jsonContent !== null) {
          ...
          <div class="card h-100 position-relative text-light">
            <div class="card-body">
              ...
              <div class="small mb-0">
                ...
                <?php if ($license): ?><span class="me-2"><?php echo _('License:'); ?> <?= esc(is_array($license)?($license[0]??''):$license) ?></span><?php endif; ?>
              </div>
            </div>
